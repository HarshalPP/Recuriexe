...
doc.moveDown()
    ...
    doc.font('Helvetica').text(`II. Original Property Tax Receipt No.${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.sellerName} S/O ${allPerameters.sellerFatherName} & Sign By ${allPerameters.sealandSignedBy}.`,{align:'left'}).moveDown() 
