...
const myEmitter = new EventEmitter();
  ...
  doc.on('end', () => console.log('PDF generated successfully!'));
    ...
    // const pdfFilename = `legaladpdf.pdf`;
...
doc.fontSize(14).font('Helvetica-Bold')
    ...
    .font('Helvetica-Bold')
        ...
        .font('Helvetica')
            .text(
      `I. Copy of Draft Co-ownership Deed  In Favour of ${allPerameters.sellerName} and ${allPerameters.buyerName}.`, {align:`left`}).moveDown()
   .text(
    `II.Copy of Praman Patra No.${allPerameters.pramanPatraNo} Dated ${allPerameters.praMANpATRADate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.sellerName} S/o ${allPerameters.sellerFatherName} Seal & Sign By ${allPerameters.pramanPatraSign}.`, {align:`left`}).moveDown()
 .text(
  `III. Copy of Property Tax Receipt No.${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.sellerName} S/o ${allPerameters.sellerFatherName} Seal & Sign By ${allPerameters.sealandSignedBy}.`, {align:`left`}).moveDown();
    ...
    .text(
      `I.That Draft Co-ownership Deed  In Favour of ${allPerameters.sellerName} and ${allPerameters.buyerName}.`, {align:`left`}).moveDown()
    .text(
      `II.That Praman Patra No.${allPerameters.pramanPatraNo} Dated ${allPerameters.praMANpATRADate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.sellerName} S/o ${allPerameters.sellerFatherName} Seal & Sign By ${allPerameters.pramanPatraSign}.`, {align:`left`}).moveDown()
    .text(
      `III.That Said Owner /Possession Holder Also Paid Property Tax Receipt No.${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.sellerName} S/o ${allPerameters.sellerFatherName} Seal & Sign By ${allPerameters.sealandSignedBy}.`, {align:`left`}).moveDown();
    ...
    // `${allPerameters.applicantName} S/o ${allPerameters.applicantFatherName} Is The Recorded Owner of Freehold Residential Land Admeasuring Area ${allPerameters.landArea} Sq Ft ${allPerameters.techFullAdress} Having A Clear And Marketable Title Over The Said Property As Per Available Record And Documents  `, {align: 'left' });
    ...
    .fontSize(11)
    .font('Helvetica-Bold')
    .text('9. Conclusion',50, 168, {align:`left`});
    doc.moveDown()
    y += 20;
    doc.font('Helvetica').text(
    ...
    doc
    .fontSize(11)
    .font('Helvetica-Bold').text('Search Certificate:',{align:`left`}).moveDown(0.5);
    y += 20;
    doc.font('Helvetica').text(
...
doc.moveDown()
    doc.font('Helvetica')
    .text(
    `1. Documents To Be Collected By ${allPerameters.partnerName} Prior To Disbursement Of Cheque-As Per below  `,{align:`left`}).moveDown(0.5)
    // .text(
    // `2. Documents Required Post Disbursement/Follow-Up-As Per Annexure-I `,{align:`left`}).moveDown()
    doc.font('Helvetica')
    .text(
  `I. Original Co-Ownership Deed Issued By Sub Ragitrar In Favour of ${allPerameters.sellerName} and ${allPerameters.buyerName}. `,{align:'left'}).moveDown()
  ...
  doc.font('Helvetica').text(`II. Original Praman Patra No.${allPerameters.pramanPatraNo} Dated ${allPerameters.praMANpATRADate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.sellerName} S/o ${allPerameters.sellerFatherName} Seal & Sign By ${allPerameters.pramanPatraSign}. `,{align:'left'}).moveDown()
    ...
    doc.font('Helvetica').text(`IV. Equitable Mortgage Deed Regarding Said Property With Actual Area And House No . 
        `,{align:'left'})
      // .font('Helvetica-Bold').text(`Documents To Be Collected By Prior To Disbursement Of Cheque-${allPerameters.partnerName} `,{align:`left`,underline:true}).moveDown(0.5);
  ...
  // `I. Original Co-Ownership Deed Issued By Sub Ragitrar In Favour of ${allPerameters.sellerName} and ${allPerameters.buyerName}. `,{align:'left'}).moveDown()
    ...
    .fillColor("black")
    .font('Helvetica-Bold')
    .font('Helvetica-Bold').text(`Documents To Be Collected By Prior To Disbursement Of Cheque-${allPerameters.partnerName} `,50,168,{align:`left`,underline:true}).moveDown(0.5);
  ...
  `I. Original Co-Ownership Deed Issued By Sub Ragitrar In Favour of ${allPerameters.sellerName} and ${allPerameters.buyerName}. `,{align:'left'}).moveDown()
    ...
    doc.font('Helvetica').text(`IV. Equitable Mortgage Deed Regarding Said Property With Actual Area And House No . `,{align:'left'}).moveDown(5)
  ...
  // const generateSanctionLetterPdf = async(res,customerId) =>{
    const legalPdf = async(customerId,logo,partnerName) =>{
...
const formatDate = (praMANpATRADate) => {
  ...
  return `${day}-${month}-${year}`; // Final format
      ...
      const allPerameters = {
        ...
        sealandSignedBy:internalLegalDATA?.taxReceipt?.signedBy||"NA",
        ...
        praMANpATRADate:internalLegalDATA?.pramanPatra?.date ||"NA",
        ...
        taxReciptDate: internalLegalDATA?.taxReceipt?.date ||"NA",
        ...
        const uploadResponse = await uploadPDFToBucket(pdfPath, `legaladpdf${Date.now()}.pdf`);
  ...
  module.exports = { sanctionLetterPdf, legalPdf };
