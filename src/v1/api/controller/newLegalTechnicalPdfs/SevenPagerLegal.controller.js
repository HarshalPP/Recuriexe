const {
  ...
  async function sanctionLetterPdf(allPerameters,logo,partnerName) {
    ...
    // const pdfFilename = `SevenPagerLegal.pdf`;
...
doc.fontSize(14).font('Helvetica-Bold')
    ...
    const loanTableData = [
      ...
      { field1: "2. Name Of The Co-Applicant:", value1: `${allPerameters.CoapplicantName} & ${allPerameters.CoapplicantName1} `},
    ...
    // .text(
    //   `I.That Gram Panchayat Issued Certificate No. ${allPerameters.gramPanchayatNo} Dated ${allPerameters.gramPanchayatDate} Issued By Sarpanch & Sachiv Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName} Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
    // .text(
    //   `II.That Noc Certificate No.${allPerameters.Noccertificateno} Dated ${allPerameters.NoccertificateDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName} Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown();
    ...
    .text(
      `${allPerameters.techFullAdress} Owner And Possessed By Mr.${allPerameters.applicantName} S/o ${allPerameters.applicantFatherName}.`,50,168, {align:`left`}).moveDown()
    .text(
      `I.That Gram Panchayat Issued Certificate No. ${allPerameters.gramPanchayatNo} Dated ${allPerameters.gramPanchayatDate} Issued By  ${allPerameters.gramPanchayatSign} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By  ${allPerameters.gramPanchayatSign}.`, {align:`left`}).moveDown()
    .text(
      `II.That Noc Certificate No.${allPerameters.Noccertificateno} Dated ${allPerameters.NoccertificateDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By ${allPerameters.Noc_certificateSign}.`, {align:`left`}).moveDown();
    ...
    .text(
      `V. Said Owner/Possession Holder Having Ownership Certificate No. ${allPerameters.ownershipNo} Dated ${allPerameters.ownershipDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By ${allPerameters.Owner_CertificateSign}.`, {align:`left`}).moveDown()
    .text(
      `VI. Said Owner /Possession Holder Also Paid Property Tax Receipt No. ${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By ${allPerameters.sealandSignedBy}.`, {align:`left`}).moveDown();
  ...
  .text(
    ...
    doc.font('Helvetica')
    .text(
    `1 Documents To Be Collected By ${allPerameters.partnerName} Prior To Disbursement Of Cheque-As Per Annexure-I`,{align:`left`}).moveDown()
    .text(
    `2. Documents Required Post Disbursement/Follow-Up-As Per Annexure-I`,{align:`left`}).moveDown()
      .font('Helvetica-Bold').text(`Documents To Be Collected By Prior To Disbursement Of Cheque-${allPerameters.partnerName} `,{align:`left`,underline:true}).moveDown();
    ...
    .font('Helvetica-Bold')
      ...
      .text(
        `VI. Property Tax Receipt No. ${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By ${allPerameters.sealandSignedBy}.`, {align:`left`}).moveDown()
      .text(
        `VI. Registered Mortgage Deed Regarding Said Property With Actual Area And House No .`, {align:`left`}).moveDown(5)
  ...
  // const generateSanctionLetterPdf = async(res,customerId) =>{
    const sevenPagerpdf = async(customerId,logo,partnerName) =>{
    ...
    const partnerModel = await lendersModel.findOne({ _id: finalsanctionDetails.partnerId});
    console.log(partnerModel,"partnerModel")
  ...
  return `${day}-${month}-${year}`; // Final format
      ...
      const allPerameters = {
        ...
        const uploadResponse = await uploadPDFToBucket(pdfPath, `SevenPagerLegal${Date.now()}.pdf`);
  ...
  module.exports = { sanctionLetterPdf, sevenPagerpdf };
