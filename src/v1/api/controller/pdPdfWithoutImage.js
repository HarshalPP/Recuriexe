...
async function generatePdfWithoutImage(res, customerId) {
    try {
      ...
      // Header
      doc.moveDown(2.3);
      doc.fontSize(15).font(fontBold).text(`PD VERIFICATION REPORT (WITHOUT IMAGE)`, { align: 'center' });
      doc.moveDown(0.5);
...
module.exports  = { generatePdfWithoutImage }
