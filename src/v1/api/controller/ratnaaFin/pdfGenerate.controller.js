...
// async function generateApplicantPdf(applicantDataPdf) {
//     console.log('Generating PDF for:', applicantDataPdf);

//     // Use path.resolve to ensure the path is correctly pointing to the project root's uploads folder
...
//     const pdfFilename = `applicant-pdf-${timestamp}.pdf`;
...
//     // Ensure the logo image path is valid
//     const logoPath = applicantDataPdf.logoImage ? path.resolve(__dirname, '../../../', applicantDataPdf.logoImage) : null;

//     // Check if the logo exists before adding it to the document
//     if (logoPath && fs.existsSync(logoPath)) {
//         doc.image(logoPath, 50, 30, { width: 100 });
//     } else {
//         console.warn('Logo image not found or path is invalid.');
//     }

//     doc.moveDown();

//     // Title for the PDF
//     doc.fontSize(18).text('Applicant Loan Details', { align: 'center' }).moveDown();

//     // Draw table headers with background color
//     function drawSectionHeader(title) {
//         doc
//             .rect(50, doc.y, 500, 20)
//             .fill('#f08080') // Light red background
//             .stroke()
//             .fillColor('#000000')
//             .fontSize(12)
...
//     // Function to add table-like rows
...
//         // Draw key cell
//         doc
//             .rect(50, yPosition, keyWidth, cellHeight)
//             .stroke()
//             .fillColor('#000000')
//             .fontSize(10)
//             .text(key, 55, yPosition + 5);

//         // Draw value cell
//         doc
//             .rect(50 + keyWidth, yPosition, valueWidth, cellHeight)
//             .stroke()
//             .fillColor('#000000')
//             .fontSize(10)
//             .text(value, 55 + keyWidth, yPosition + 5);

//         doc.moveDown(0.7);
//     }

//     // Add application, loan, and sourcing details
...
//     addSection('Application Details', applicantDataPdf.applicationDetails);
//     addSection('Loan Details', applicantDataPdf.loanDetails);
//     addSection('Sourcing Details', applicantDataPdf.sourcingDetails);
...
async function generateApplicantPdf(applicantDataPdf) {
    ...
    function addHeader() {
        ...
        doc.image('assets/image/FINCOOPERSLOGO.png', 400, 20, { fit: [150, 50], align: 'right', valign: 'bottom' })
    }
    ...
    const loanTableData = [
        { field1: 'Loan Amount Requested:', value1: '240000' },
        { field1: 'Loan Tenure Requested (in months)', value1: '46' },
    ...
    const imageBuffer1 = await sharp("uploads/image_1721246055105.605192.png").resize(115, 130).toBuffer()
    const imageBuffer2 = await sharp("uploads/image_1721246055105.605192.png").resize(115, 130).toBuffer()
    ...
    const applicantDetailData = [
        { field1: 'Applicant Type', value1: 'MAIN APPLICANT' },
        { field1: 'Business Type', value1: 'AGRICULTURE' },
        { field1: 'Applicant Name', value1: 'BADRILAL' },
        { field1: 'PSL Classification', value1: 'NA' }
    ];
    ...
    const communicationAddressData = [
        { field1: 'Address', value1: 'MAKAN NO 27 GRAM BAMAN KHEDA POST BARKHEDA KALA TEHSIL ALOTE KALAKHEDI RATLAM BARKHEDA KALAN MADHYA PRADESH 457114' },
        { field1: 'Tel (STD Code)', value1: 'NA' },
        { field1: 'Mobile', value1: '9303258657' },
        { field1: 'Years at current address', value1: '' },
        { field1: 'Email ID', value1: 'BADRILAL@gmail.com' }
    ];
    ...
    const officeAddressData = [
        ...
        { field1: 'Years at current address', value1: '' },
        { field1: 'Email ID', value1: 'BADRILAL@gmail.com' },
        { field1: 'Date of Birth/Incorporation :', value1: '01/01/1974' },
        { field1: 'GST No.', value1: 'NA' },
        { field1: 'CIBIL Consent :', value1: 'Yes' },
        { field1: 'CIN/UDYOG ADHAAR :', value1: '360015111323' },
        { field1: 'PAN :', value1: 'FYWPB2419B' },
        { field1: 'TAN No. :', value1: 'NA' },
    ...
    const coApplicantData = [
        { field1: 'Co-Applicant/Guarantor Name', value1: 'ARVINDA BAI' },
        { field1: 'Type', value1: 'INSTA FINANCIAL' },
        { field1: 'Role', value1: 'CO-APPLICANT' },
        { field1: 'Relation with Applicant', value1: 'WIFE' }
    ];
    drawTable('Co-Applicant / Guarantor Details - 1', coApplicantData);
    doc.moveDown();

    const permanentAddressData = [
        { field1: 'Address', value1: 'MAKAN NO 003 VARD NO 009 BAMAN KA KHEDA THN ALOT RATLAM KALAKHEDI RATLAM BARKHEDA KALAN MADHYA PRADESH 457114' },
        { field1: 'Tel (STD Code)', value1: 'NA' },
        { field1: 'Mobile', value1: '9303258657' },
        { field1: 'Email ID', value1: 'INFO@PROCONF.COM' },
        { field1: 'Years at permanent residence', value1: '' },
        { field1: 'PAN', value1: 'GTLPB0779B' },
        { field1: 'Gender', value1: 'FEMALE' },
        { field1: 'Education Qualification', value1: 'NA' },
        { field1: 'Address Proof Type', value1: '63020844374' },
        { field1: 'Date of Birth', value1: '01/01/1975' }
    ];
    ...
    const currentResidenceData = [
        ...
        { field1: 'Mobile', value1: '9303258657' },
        { field1: 'Email ID', value1: 'INFO@PROCONF.COM' },
        { field1: 'Years at current residence', value1: '' },
        { field1: 'PAN', value1: 'GTLPB0779B' }
    ];
    ...
    const imageBuffer3 = await sharp("uploads/image_1721246055105.605192.png").resize(115, 130).toBuffer()
    ...
    const permanentAddressGTRData = [
        { field1: 'Address', value1: 'H NO 18WARD NO08 TAH ALOT BALAVATA BARKHEDAKALAN RATLAM MADHYA PRADESH 457114' },
        { field1: 'Tel (STD Code)', value1: 'NA' },
        { field1: 'Mobile', value1: '7389579231' },
        { field1: 'Email ID', value1: 'BADRILAL.HARIJAN@gmail.com' },
        { field1: 'Years at permanent residence', value1: '' },
        { field1: 'PAN', value1: 'BFBPH2982C' },
        { field1: 'Gender', value1: 'MALE' },
        { field1: 'Education Qualification', value1: 'NA' },
        { field1: 'Address Proof Type', value1: '563286128877' },
        { field1: 'Date of Birth', value1: '01/01/1967' }
    ];
    ...
    const collateralDetailsData = [
        ...
        { field1: 'Address', value1: 'HOUSE NO 27 SURVEY NO 5 PATWARI HALKA NO 6 WARD NO 13 VILLAGE BAMANKHEDA GRAM PANCHAYAT MORIYA TEHSIL ALOT DISTRICT RATLAM STATE MADHYA PRADESH PIN CODE 457114' }
    ];
    ...
    const bankingDetailsData = [
        { field1: 'Name of Bank', value1: 'AU SMALL FINANCE BANK' },
        { field1: 'Branch', value1: 'ALOT' },
        { field1: 'Account No', value1: '2261727044549233' },
        { field1: 'Account Type', value1: 'SAVING' },
        { field1: 'If overdraft, Limit', value1: 'NA' },
        { field1: 'No of years', value1: 'NA' }
    ];
    ...
    doc.end();
    const objData = {
        fileName: "section letter",
        file: doc.toString('base64')
    }
    await initESign(objData)
}

async function generateLoanAggrementPdf(applicantDataPdf) {
    ...
    // Define some styles and settings
    ...
    // Loop through the contentArray and add paragraphs to the PDF
    contentArray.forEach((paragraph, index) => {
        // Check if the current page has enough space for the paragraph; if not, create a new page
        if (currentY + lineHeight * paragraph.split(' ').length / 10 > doc.page.height - marginTop) {
            doc.addPage();
            currentY = marginTop; // Reset y position on the new page
        }

        // Add the paragraph text at the current position
        doc.text(paragraph, marginLeft, currentY, {
            width: doc.page.width - marginLeft * 2,
            align: 'justify',
            lineGap: 5 // Space between lines
        });

        // Update the y position for the next paragraph
        currentY += lineHeight * Math.ceil(paragraph.length / 100) + paragraphSpacing;
    });
...
module.exports = { generateApplicantPdf, generateLoanAggrementPdf };
