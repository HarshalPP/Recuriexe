    ...
    sections: [
        {
          properties: {
            ...
            children: [
                ...
                new Paragraph({
                    text: `This memorandum made at ${allPerameters.applicantDistrict}  on dated   ${allPerameters.currentDate} , Mr. ${allPerameters.propertyOwnerName} S/O ${allPerameters.propertyOwnerFatherName}  (Property Owner) ID NO.  ${allPerameters.propertyPanNo}   hereinafter called "THE MORTGAGOR" (which expression shall unless it be repugnant to the context or meaning thereof be deemed to include his, executors, administrators and assigns) of the ONE PART, and GROW MONEY CAPITAL PVT LTD. having its Registered Office at 401, New Delhi House,27 Barakhamba Road, Connaught Place, New Delhi-110001  and also a Branch Office at ${allPerameters.BranchName}  (M.P.) hereinafter called as "THE MORTGAGEE" (which expression shall unless it be repugnant to the context or meaning thereof be deemed to include his/her/their heirs, executors, administrators and assigns) of the OTHER PART.`,
                    spacing: { after: 300 },
                }),
                ...
                new Paragraph({
                  text: `1.	The mortgagor declare and record that the  deeds and documents and writings comprised in the Second Schedule hereunder written relating to the said property, more particularly described in the First Schedule, hereunder written, had been deposited by the Mortgagor with GROW MONEY CAPITAL PVT LTD.  at their ${allPerameters.BranchName}  branch of the mortgagee on dated ${allPerameters.currentDate}  and by way of mortgage security by deposit of  deeds and documents for securing loan/credit facility granted by the mortgagee to the Mortgagor with interest thereon and for all costs, charges and expenses incurred by the mortgagee in connection therewith. `,
                  spacing: { after: 250 },
              }),

                new Paragraph({
                    text: `2.	The mortgagor further declare and record that the  deeds and documents and writings comprising in the Second Schedule hereunder written relating to the said property, more particularly described in the First Schedule accepted by said Mr. ${allPerameters.authorizedperson}  he Authorized person of GROW MONEY CAPITAL PVT LTD.  at their ${allPerameters.BranchName}  branch of the mortgagee on dated  ${allPerameters.currentDate}   and by way of mortgage security by deposit of  deeds and documents for securing loan/credit facility granted by the mortgagee to the Mortgagor ${allPerameters.roi} with interest thereon and for all costs, charges and expenses incurred by the mortgagee in connection therewith.`,
                    bold: true,
                    underline: true,
                    spacing: { after: 250 },
                }),
...
const GmRmDeedPdf = async (customerId,logo,partnerName,res) => {
  ...
  console.log("Matching PAN No:", panNo);
   ...
   console.log(pdfBuffer,"pdfBuffer")
    ...
    const uploadResponse = await uploadPDFToBucket(pdfBuffer, `GmRmDeed${Date.now()}.docx`);
