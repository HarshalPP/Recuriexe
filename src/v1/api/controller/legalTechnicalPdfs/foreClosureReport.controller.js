...
doc.moveDown(2);
doc.font(font).fillColor("black").text(`Dated: ${allPerameters.date}`, 50, 150,{align:'right'});
doc.moveDown();
...
doc.fontSize(14).font('Helvetica-Bold')
    ...
    doc.text(`Loan Application Of :                 ${allPerameters.applicantName} & ${allPerameters.CoapplicantName}`, { align: 'left' }).moveDown(0.6);

    doc.text('Title Search Report/ Legal Verification Of Documents In Respect Of Freehold Residential House', { align: 'left' }).moveDown(0.6);
    doc.text('Built On', { align: 'left' });
    doc.text(`${allPerameters.techFullAdress}`, { align: 'left' }).moveDown(0.5);
    ...
    const loanTableData = [
      ...
      { field1: "2. Name Of The Co-Applicant:", value1: `${allPerameters.CoapplicantName}` },
    ...
    .fillColor("black")
    .font('Helvetica-Bold')
        .text('7. Copy Of Documents\n Examined:',50, 150, {align:`left`}).moveDown();

        doc.fontSize(11)
        .font('Helvetica')
            .text(`I.Copy Co-Ownership No${allPerameters.coOwnerShipDeedNo} Dated ${allPerameters.coOwnerShipDeedDate} Issued By Sarpanch & Sachiv Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName} Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
    ...
    doc.font('Helvetica')
    .text(
        `I.That Gram Panchayat Issued Certificate No. ${allPerameters.gramPanchayatNo} Dated ${allPerameters.gramPanchayatDate} Issued By Sarpanch & Sachiv  Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName} Seal & Sign By Sarpanch & Sachiv.`,  50, 150,{align:`left`}).moveDown()
    .text(
    ...
    .text(
      `V.Said Owner /Possession Holder Also Paid Property Tax Receipt No.${allPerameters.taxReciptNo} Dated ${allPerameters.taxReciptDate} For Current Year Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName}Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
      .text(
    ...
    y += 20;
    doc.font('Helvetica').text(
    `${allPerameters.applicantName} S/O ${allPerameters.applicantFatherName} Is The Recorded Owner Of Freehold Residential Land Admeasuring Area ${allPerameters.landArea} Sq Ft ${allPerameters.techFullAdress} Having A Clear And Marketable Title Over The Said Property As Per Available Record And Documents.`, {align: 'left' }).moveDown();
  ...
  .text(
    ...
    .fillColor("black")
    .fontSize(11)
    .font('Helvetica-Bold').text('Encl:-Electro State Copy Of Documents Examined As Per Para 7 (I To Vi)',50, 150,{align:`left`}).moveDown()
    ...
    doc.font('Helvetica')
    .text(
    `1.Documents To Be Collected By ${allPerameters.partnerName} Prior To Disbursement Of Cheque-As Per Annexure-I`,{align:`left`})
    .text(
    ...
    .text(
      ...
      .text(
        ...
        .text(
            `VIII. LOD and NOC OF ${allPerameters.BT_BANK_NAME}.`, {align:`left`}).moveDown(3)
