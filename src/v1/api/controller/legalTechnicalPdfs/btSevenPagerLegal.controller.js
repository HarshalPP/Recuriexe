...
doc.fontSize(14).font('Helvetica-Bold')
    ...
    .font('Helvetica-Bold')
        ...
        doc.fontSize(11)
        .font('Helvetica')
            .text(`I.Copy Gram Panchayat No${allPerameters.gramPanchayatNo} Dated ${allPerameters.gramPanchayatDate} Issued By Sarpanch & Sachiv Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
            .text( `II.Copy Noc Certificate No.${allPerameters.Noccertificateno} Dated ${allPerameters.NoccertificateDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName }Seal & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
            .text( `III.Copy Building Permission Certificate No. ${allPerameters.BuildingPermissionNo} Dated ${allPerameters.BuildingPermissionDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour of ${allPerameters.propertyOwnerName} S/o ${allPerameters.propertyOwnerFatherName} & Sign By Sarpanch & Sachiv.`, {align:`left`}).moveDown()
  ...
  .text(
    ...
    .text(
      ...
      .font('Helvetica')
      .text(
        `V.Original Ownership Certificate No. ${allPerameters.ownershipNo} Dated ${allPerameters.ownershipDate} Gram Panchyat ${allPerameters.gramPanchayat} Tehsil  ${allPerameters.Tehsil} District  ${allPerameters.district} State  ${allPerameters.state} In Favour Of ${allPerameters.propertyOwnerName} S/O ${allPerameters.propertyOwnerFatherName} Seal & Sign By Sarpanch & Sachiv.`,50,168,{align:`left`}).moveDown()
      .text(
