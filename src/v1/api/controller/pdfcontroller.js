...
async function growpdf(candidateDetails) {
  ...
  function addFooter(doc) {
    ...
    doc.font(fontBold).fontSize(6.3).fillColor("#324e98").text("FinCoopers Capital Pvt Ltd", pageWidth, pageHeight - 80, { align: "center" });
    ...
    doc.font(fontBold).fontSize(6.3).fillColor("#000000").text("Phone: +91 7374911911 | Email: hr@fincoopers.com", { align: "center" });
  ...
  doc.font(fontBold)
    .fontSize(9)
    .text(`Date:                                   ${moment().format("DD/MM/YYYY")}`, { align: "left" });
  doc.text(`Application Form No:    GMCFIN0113`, { align: "left" });
...
following information and have accordingly filled up the aforesaid form.`);
 ...
 /// make a function Singnature //
  ...
  function drawTable2(sectionTitle, data) {
    doc.moveDown(2);
    const titleHeight = 20;
    const titleX = 48;
    const titleWidth = doc.page.width - 2 * titleX;
    ...
    doc.font(fontBold)
      .fontSize(11)
      .fillColor("#20211A")
      .text(sectionTitle, titleX + 5, doc.y + 3);

    // want to make a table in section title //
    ...
    data.forEach((row, index) => {
      ...
      const fillColor = index % 2 === 0 ? "#f5f5f5" : "#ffffff"; // Alternate row colors
  ...
  const loanDetails = [
    { key: "Loan Amount Requested", value: candidateDetails.loanAmount || "220000" },
    { key: "Loan Tenure Requested (in months)", value: candidateDetails.loanTenure || "31" },
    { key: "Loan Purpose", value: candidateDetails.loanPurpose || "BUSINESS EXPANSION" },
    { key: "Loan Type", value: candidateDetails.loanType || "SECURED" },
  ];
  ...
  const sourcingDetails = [{
    key: "Sourcing Type",
    value: candidateDetails.loanAmount || "NA",

  }, {
    key: "Gen Partner Name",
    value: candidateDetails.genPartnerName || "NA",
  }, {
    key: "Sourcing Agent Name : ",
    value: candidateDetails.sourcingAgentName || "NA",
  }, {
    key: "Sourcing Agent Code : ",
    value: candidateDetails.sourcingAgentCode || "NA",
  }, {
    key: "Sourcing Agent Location : ",
    value: candidateDetails.sourcingAgentLocation || "NA",
  }, {
    key: "Sourcing RM Name : ",
    value: candidateDetails.sourcingRMName || "NA",
  }, {
    key: "Sourcing RM Code : ",
    value: candidateDetails.sourcingRMCode || "NA",
  }]
  ...
  const applicantDetails = [
    ...
    {
      key: "Application Type", value: "FINANCIAL"
    }, {
      key: "Business Type", value: "AGRICULTURE"
    }, {
      key: "Applicant Name", value: "BHERU SINGH"
    }, {
      key: "Father/Spouse Name", value: "KALU SINGH"
    }, {
      key: "Applicant Mother Name", value: "NA"
    }, {
      key: "Mobile No.1", value: "9926059352"
    }, {
      key: "Mobile No.2", value: "9926059352"
    }, {
      key: "Email ID", value: "bharat12@gmail.com"
    }, {
      key: "Education Qualification", value: "UNDER GRADUATE"
    }, {
      key: "Applicant DOB", value: "01/01/1982"
    }, {
      key: "Gender", value: "01/01/2000"
    }, {
      key: "Marital Status", value: "MARRIED"
    }, {
      key: "Pan Number", value: "PGIPS3324G"
    }, {
      key: "Aadhar Number", value: "43567890876"
    }, {
      key: "Voter Id Number", value: "NA"
    }
  ];
  ...
  const communicationAddress = [
    {
      key: "Aadhar as per Aadhar", value: "43567890876",

    }, {
      key: "Name of the City/Town/Village", value: "Dhamgav",
    }, {
      key: "District Name", value: "Rajgarh"
    }, {
      key: "Pin Code", value: "454353"
    }, {
      key: "State", value: "Madhya Pradesh"
    }, {
      key: "Years at current address", value: "5"
    }
  ]
  ...
  const PermanentAddress = [
    {
      ...
      key: "Address", value: "Dhamgav",
    }, {
      key: "Name of City/Town/Village", value: "Dhamgav",
    }
  ]
  ...
  drawTable3("Applicant Details", applicantDetails, imagelogo);
  doc.moveDown(1);
  ...
  const coApplicantDetails = [
    {
      key: "Co-Applicant Type", value: "NA",
    }, {
      key: "Co-Applicant Name", value: "NA",
    }, {
      key: "Relation with Applicant ", value: "NA",
    }, {
      key: "Co-Applicant Father/Spouse Name", value: "NA",
    }, {
      key: "Co-Applicant Mother Name", value: "NA",
    }, {
      key: "Mobile No.1", value: "NA",
    }
    , {
      key: "Email ID", value: "NA",
    }, {
      key: "Education Qualification", value: "NA",
    }, {
      key: "Co-Applicant DOB", value: "NA",
    }, {
      key: "Gender", value: "NA",
    }, {
      key: "Marrital Status ", value: "NA",
    }, {
      key: "Pan Number", value: "NA",
    }, {
      key: "Aadhar Number", value: "NA",
    }, {
      key: "Voter Id Number", value: "NA",
    }
  ]
  ...
  const communicationAddressco = [
    {
      key: "Aadhar as per Aadhar", value: "NA",

    }, {
      key: "Name of the City/Town/Village", value: "NA",
    }, {
      key: "District Name", value: "NA"
    }, {
      key: "Pin Code", value: "NA"
    }, {
      key: "State", value: "NA"
    }, {
      key: "Years at current address", value: "NA"
    }
  ]
  ...
  const GuarnatorParentAddress = [
    {
      ...
      key: "Address",
      value: "GRAM GANESH GANJ POST BADGANV TAHSIL JIRAPUR BADGAON RAJGARH"
    }, {
  ...
  // addLogo(doc);
  // doc.moveDown(3)
  // drawNewPage(GuarnatorParentAddress1)
  // addFooter(doc);
  ...
  const CollateralsDetails = [
    ...
    { key: "Address", value: "HOUSE NO 23 SURVEY NO 95 PATWARI HALKA NO 35 WARD NO 04 VILLAGE GULKHEDIGRAM PANCHYAT GULKEDI TEHSIL JIRAPUR DISTRICT RAJGARH STATE MADHYAPRADESH PIN CODE 465693" }
  ]

  const BankDetails = [
    { key: "Name of Bank", value: "BANK OF INDIA" },
    { key: "Branch", value: "RAJGARH" },
    { key: "Account No", value: "1234567890" },
    { key: "Account Type", value: "SAVING" },
    { key: "IFSC Code", value: "BKID0001234" },
  ]
  ...
  const ReferanceDetails = [
    { 
      key: "Reference 1 - Name", value: "HARIOM" ,
    },{ 
      key: "Reference 1 - Relation", value: "PATIL" 
    },{ 
      key: "Reference 1 - Address", value: "GULKHEDI" 
    },{ 
      key: "Reference 1 - Mobile Number", value: "7489256278"
     },{},
     {
       key: "Reference 2 - Name", value: "KEVAL" 

    },{ key: "Reference 2 - Relation", value: "PATIL"

     },
    { 
      key: "Reference 2 - Address", value: "GULKHEDI" 
    },
    { 
      key: "Reference 2 - Mobile Number", value: "7489256278" 
    }
  ]
  ...
  doc.fontSize(contentFontSize)
    .text("I/We hereby acknowledge and conirm that:", {
      width: textWidth,
      lineGap: lineSpacing,
      align: 'justify',
    })
  ...
  const declarations = [
    ...
    "I hereby declare that I am not involved in any type of production or trading activity that comes under International Finance Corporation exclusion list.\nProduction or trade in any product or activity deemed illegal, pharmaceuticals, pesticides/herbicides, ozone-depleting substances, PCB's, wildlife, weapons, munitions, alcoholic beverages (excluding beer and wine), tobacco, Gambling, casinos, radioactive materials, unbonded asbestos fibers, drift net fishing in the marine environment.",
    "The executive of Fin Coopers Capital Pvt Ltd (Lender), collecting the application/documents has informed me/us of the applicable schedule of\ncharges, fees, commissions, and key facts, as more particularly mentioned in the “Schedule of charges” on the website of the company.",
    "Submission of loan application to the lender does not imply automatic approval by the lender and the lender will decide the quantum of the loan\nat its sole & absolute discretion. The lender in its sole and absolute discretion may either approve or reject the application for granting the loan. In\ncase of rejection, the lender shall not be required to give any reason",
    "I/We authorized and give consent to Fin Coopers Capital Pvt Ltd to disclose, without noticing me/us, the information furnished by me/us in the\napplication form(s)/ related documents executed/to be executed in the relation to the facilities to be availed by me/us from Fin Coopers Capital Pvt\nLtd, to other branches/Subsidiaries/afiliates/credit Bureaus/to the credit information Bureaus of India (CIBIL)/Rating Agencies/service provider,\nBanks/inancial institutes, governmental/regulatory authorities or third parties who may need, process & publish the information in such manner\nand through such medium as it may be deemed necessary by the lender/RBI, including publishing the name as part of wilful defaulter’s list from\ntime to time, as also use for KYC information veriication, credit risk analysis or for any other purposes as the lender deemed necessary.",
    "I/We declare that all the particulars and information and documents provided with this form are genuine, true, correct, complete, and up to date\nin all respects and that I/We have not withheld/suppressed any information/document whatsoever. I/We also authorized Genesis Securities Pvt\nLtd to use the documents, download records from CKYCR using the KYC identiier submitted, video record the KYC document, personal discussion,\nand any other information provided herewith to extract additional information from the various public domains, including but not limited to\nCIBIL/Bureau report, Perios report, etc. or for any other regulatory & compliance-related matters, prior to sanction/post sanction.",
    "I/We have been informed of the documents to be submitted with the loan application form and have submitted the same. I/We shall furnish any \nadditional documents as and when required by the lender.",
  ];
  ...
  const DeclarationDetails = [
    "The executive collection of the application/documents has informed me/us of the rate of interest and approach for gradation of risk and rational\nof charging different rates of interest to different categories of borrowers, the particulars whereof have speciied in the Loan Application form.",
    "The rate of interest is arrived at based on various factors such as cost of funds, administrative cost, risk premium, margin, etc. The decision to\ngive a loan and the interest rate applicable to each loan account are assessed on a case-to-case basis, based on multiple parameters such as\nborrower proile, repayment capacity, the asset being inanced, borrower’s other inancial commitments, past repayment track record, if any,security, tenure, etc. The rate of interest is subject to change as the situation warrants and is subject to the discretion of the company",
    "The credit decision is based on the credit model which includes factors like credit history, repayment track record, banking habit, business\nstability & cash low analysis which is assessed through a combination of personal discussion and documentation",
    ...
    "The loan term as sanctioned are applicable for the speciied product as indicated in the loan application and are valid for the period of 60 days\nonly. Where for some reason, there is a delay in concluding the loan, the lender reserve the right to revise the loan term as may be applicable at the\ntime of actual loan availment upon providing a copy of revisions to me/us",
    "All the particulars and the information and details are given/illed in this application form are true, correct, complete, and up to date in all\nrespects, and I/We have not withheld any information whatsoever.",
    "Any fault or misrepresentation in the documents will be my/our sole responsibility and Fin Coopers Capital Pvt Ltd has the authority to take\nrightful action against any such fault/misrepresentation.",
    " I/we shall inform the lender regarding any changes in my/our address(s) or my employment or profession, or any material deviation from the\ninformation provided in the loan application form.",
    "I/We hereby conirm that I/we am/are competent and fully authorized to give declarations, undertaking, etc and to execute and submit this\napplication form and all other documents for the purpose of availing the loan, creation of security, and representing generally for all the purposes",
    "I/We acknowledge and understand that the application/processing fees collected from me/us by Fin Coopers Capital Pvt Ltd, is for reviewing\nthe loan application as per its own parameters and its not refundable to me/us under any circumstances whatsoever, irrespective of whether Fin\nCoopers Capital Pvt Ltd sanction this loan application of mine or not. No cash has been given by me/us to any person for whatsoever reason\nrelated to the loan application.",
    "The lender has the right to retain the documents along with the photographs submitted with the loan application, and the same will not be\nreturned to the applicant.",
  ...
  const DeclarationDetails2 = [
    ...
    "Details with respect to the EMI presentation dates, number of EMIs, amount, and other terms & conditions of the loan will be communicated\nseparately along with the welcome letter.",
    "No discount/fees gifts or any other commitment is given whatsoever which is not documented in the loan agreement by the lender or any of its\nauthorized representative(s).",
    "The lender shall make all attempts to process the application and disburse the loan within 30 (thirty) working days from the date of the\ncompletion and submission of all relevant loan documents as speciied therein.",
    ...
    "Fin Coopers shall have a right to either process and disburse the entire loan amount singly or jointly together with such other co-lending\npartners i.e. bank/NBFCs as it may be deemed fit."
  ]
...
const sectionB = [
  ...
  ["Foreclosure Charges (Within 12 Months)", "NA", "6%", "NA"],
  ["Foreclosure Charges (After 12 Months)", "NA", "5%", "NA"],
];

const footerNote = "There are no charges on foreclosure or pre-payment on floating rate term loans. The above part prepayment and foreclosure charges are subject to regulatory requirements.";
...
// Data for the table
const fiveColumnData = ['eld collection charges per E' ,'NA',  'NA' ,'' , 'NA'];
...
const text3=`# Meaning of Composite Criteria - If an enterprise crosses the ceiling limits speciied for its present category in either of the two criteria of
...
lower category unless it goes below the ceiling limits speciied for its present category in both the criteria of investment as well as turnover
`
...
`,
  documentDetails:`Passport (Not Expired), Pan Card OR Form 60,\nVoters ID card with complete date of Birth, Driving
License (Not Expired), High School Mark sheet/ Certiicate,\nLIC policy bond with latest premium paid
...
`
  ...
  documentDetails:` Passport (Not Expired), 
  Pan Card OR Form 60, 
  Driving License (Not Expired),
  Copy of any cheque issued in favor of Genesis Securities Pvt Ltd.
 (Subject to cheque must be cleared),
  Identity card with applicants photograph &
  sign issued by Central/State Government Departments,
 Original Bankers,Veriication (not older than 30 days)`
    
  },{

    documentName:`Income Proof*`,
    documentDetails:`  Latest ITR, Latest Form 16,
    Latest Salary Slip/Certiicate,
    Latest Audited Financials,
    Bank details with
    last 3 months salary
    credited, Add- Business Proof-Qualiication 
    Certiicate/Certiicate of Practice (COP),
    Shop Act License/MOA & AOA/Sales
    TaxNat registration/Partnership Deed`
  },
  {documentName:`Property Document*`,
  documentDetails:` Copy of original sales deed, 
  Allotment possession letter, 
  NOC from society and other documents as per
  legal report. 
  The application will be assessed quickly after receiving the required documents`
  },{
    documentName:`Proof of Identity &Address: (For Individual /Authorized Person)`,
    documentDetails:`Passport (not expired), 
PAN Card, Voter’s Identity Card issue by Election Commission of India, Driving
License, Proof of Possession of Aadhar (Voluntary),
Job Card Issued by NREGA duly signed by ofice of
State Govt and Letter issued by the
National Population Register
containing details of name and address,
Ration Card, Bank Statement,
Electricity/Telephone Bill,
Sale deed/property purchase agreement (for owned properties)`
  },{
    documentName:`For Trust:
   [Certiied copies of each of the following
   documents]`,

    documentDetails:` Registration Certiicate,
    Trust Deed, PAN No. or Form 60 of Trust,
    Documents relating to beneicial
   owner, trustees’ managers,
   oficers or employees as the case may be,
   holding an attorney to transact
   on its behalf.
`,
  }
];
...
const datatables =[
  {
documentName:`For Sole Proprietorship: [Certiied copy
of any two* of the following documents
in the name of the proprietary concern]`,
documentDetails:`* Proof of Identity/Address of Individual, Registration Certiicate, Certiicate/licence issued by the municipal authorities under Shop and Establishment Act., Sales and income tax returns, CST/VAT/ GST
certiicate (provisional/inal), Certiicate/registration document issued by Sales Tax/Service
Tax/Professional Tax authorities, Importer Exporter Code issued by the ofice of DGFT or License/
Certiicate of practice issued in name of the Proprietary concern by professional body incorporated
under statute, The complete Income Tax Return in the name of the sole proprietor where the irm’s
name and income is relected duly authenticated/acknowledged by the Income Tax Authorities, Utility
bills such as electricity, water, and
landline telephone bills in the name of the proprietary concern`

  },
  {
documentName:`For Society Unregistered Partnership Firm:[Certiied copy of any two* of thefollowing documents in the name of the proprietary concern]`,
...
of individuals`},{
  ...
  documentName:`Note`,
  documentDetails:`1) * Documents relating to beneicial owner, managers, partners, trustees, oficers or employees,
...
doc.moveDown(5);
  ...
  function createAadhaarConsentPDF(executants) {
    ...
    doc.moveDown(1);
    const date = '15/11/2024';
    const place = 'KHILCHIPUR';
...
const textIndent = 10; // Custom right alignment indent
    ...
    doc.moveDown(1.5)
    doc.text(`BHERU SINGH`)
    doc.moveDown(1)
    doc.text(`PAVITRA BAI`)
    doc.moveDown(1)
    doc.text(`BHAGWAN SINGH PARMAR`)
...
async function growpdff(req, res) {
  try {
    const pdfPath = await growpdf(req.body);
...
module.exports = { growpdf, growpdff };
