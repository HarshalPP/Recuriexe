...
const pdfLogo1 = path.join(
  __dirname,
  "../../../../../assets/image/naamdev.png"
);
...
async function ratannaFinSanctionLetterPdf(allPerameters) {
  ...
  function addLogo() {
    // Check and add the right logo (pdfLogo)
    if (fs.existsSync(pdfLogo)) {
      doc.image(pdfLogo, 400, 9, {
        fit: [160, 75],
        align: "right",
      ...
      console.error(`Right logo file not found at: ${pdfLogo}`);
    }
  
    // Check and add the left logo (pdfLogo1)
    if (fs.existsSync(pdfLogo1)) {
      doc.image(pdfLogo1, 40, 9, {
        fit: [160, 80],
        align: "left",
        valign: "bottom",
      });
    } else {
      console.error(`Left logo file not found at: ${pdfLogo1}`);
    }
  }
  ...
  // const pdfFilename = `NaamDev_SanctionLatter.pdf`;
...
`,startX, doc.y, { align: "left", x: 50 })
    ...
    .font('Helvetica-Bold')
    .fontSize(8)
    .text(`Email Address & Contact Nos to be used for customer service / for assistance required post disbursement: info@namfin.in, 01412250026`,startX, doc.y, { align: "left", x: 50 })
    .moveDown(0.3);
...
// }
    ...
    const  termsConditionTable = [
      ...
      { field1: "2", value1: `Facility is subject to satisfactory compliance of all terms and conditions as stipulated in the legal opinion report, the title of which should be clear and marketable given by the Namdev Finvest Private Limited’s approved lawyer and the cost of which should be borne by the Borrower or the Guarantor, as the case may be.` },
      { field1: "3", value1: `Facility account will be setup subject to technical clearance of the property to be mortgaged, as assessed by Namdev Finvest Private Limited.` },
      { field1: "4", value1: `The quantum of Facility amount will be based on a satisfactory valuation report from the Namdev Finvest Private Limited’s approved valuer.` },
      { field1: "5", value1: `The security charged to the Namdev Finvest Private Limited including property etc. should be comprehensively insured (fire, riots and other hazards like earthquake, floods, etc.) with Namdev Finvest Private Limited Clause and the policy document /a copy of the policy document to be submitted for.` },
      { field1: "6", value1: `The property shall be well maintained at all times and during the pendency of the loan if the property suffers any loss on account of natural calamities or due to riots etc., the same should be intimated to the Namdev Finvest Private Limited without fail.` },
      { field1: "7", value1: `Borrower and the Guarantor shall not voluntarily cause any harm to the property that may in any way be detrimental to the interests of the Namdev Finvest Private Limited. You shall make up for any loss incurred to the Namdev Finvest Private Limited on account of any damages occurring to the property due to deviation from the approved plan.` },
      { field1: "8", value1: `You will ensure that the property tax is promptly paid.` },
      { field1: "9", value1: `You will not be entitled to sell, mortgage, lease, surrender or alienate the mortgaged property, or any part thereof, during the subsistence of the mortgage without prior intimation to the Namdev Finvest Private Limited.` },
      ...
      { field1: "11", value1: `FRR as applicable on the date of disbursement and the same shall be reset at an interval as per the internal Guidelines of Namdev Finvest Private Limited. It shall be the responsibility of the borrower(s) to inquire or avail from Namdev Finvest Private Limited the details thereof on the reset date specified in the agreement. Namdev Finvest Private Limited is entitled to change the reset frequency at any point of time.` },
      ...
      { field1: "14", value1: `The Namdev Finvest Private Limited is authorised to debit Processing fees and other charges / insurance premium mentioned in the sanction\n\n letter from the account/s of the firm company maintained with the Bank.` },
      { field1: "15", value1: `The Borrower and Security Providers shall be deemed to have given their express consent to the Namdev Finvest Private Limited to disclose the information and data furnished by them to the Namdev Finvest Private Limited and also those regarding the credit facility or facilities enjoyed by the borrower, conduct of accounts and guarantee obligations undertaken by guarantor to the Credit Information Companies , or any other credit bureau or RBI or any other agencies specified by RBI who are authorized to seek and publish information, upon signing the copy of the sanction letter.` },
      { field1: "16", value1: `The Namdev Finvest Private Limited also reserves the right to assign, securitize or otherwise transfer the loan hereby agreed to be granted or a portion thereof to any person or third party assignee without any notice or consent along with or without underlying security or securities whether movable and or immovable created or to be created for the benefit of the Namdev Finvest Private Limited and pursuant to which the assignee shall be entitled to all or any rights and benefits under the loan and other agreements and or the security or securities created or to be created by me or us or the security providers.` },
    ];
...
//     //----------------------------------------------------new page 5-------------------------------
    ...
    const  standardConditionTable = [
      ...
      { field1: "1", value1: `The facility is subject to the borrower furnishing any information or documents or to submit or execute the relevant post disbursement documents, as required by the Namdev Finvest Private Limited.` },
      ...
      { field1: "3", value1: `The Borrower(s) hereby agree(s) and confirms that Ratnaafin Capital Private Limited shall have the absolute right to levy such charges as it may deem fit including but not limited to Cheque bounce / return and any other penal charges for the delayed/ late payment or otherwise. The Borrower(s) agree(s) that in the event of such a levy, the Borrower(s) shall forthwith pay the said amount without demur or protest and that it shall not object to such levy nor claim waiver of or make a claim or a defence that the same was not brought to his/her/ their notice. The Borrower(s) is / are aware of the fact that it is not mandatory for Namdev Finvest Private Limited to inform either in advance or subsequently of the said levy and/ or change in the levy or introduction of such levy. It shalt be the responsibility of the Borrower(s) to enquire or avail fromNamdev Finvest Private Limited the details thereof.` },
      { field1: "4", value1: `The Namdev Finvest Private Limited may at its sole discretion disclose such information to such institution(s) / bank in connection with the credit facilities granted to the borrower.` },
      { field1: "5", value1: `The Namdev Finvest Private Limited will have the right to examine at all times, the borrower's books of accounts and to have the its offices/ sites/ factory(ies)/ stocking points inspected from time to time by officer(s) of the Namdev Finvest Private Limited and / or qualified auditors and / or technical experts and / or management consultants of the Namdev Finvest Private Limited’s choice. Cost of such inspection shall be borne by the borrower.` },
      { field1: "6", value1: `During the currency of the Namdev Finvest Private Limited’s facilities, the borrower will not without the permission of the Namdev Finvest Private Limited in writing a)Effect any Change in management structure b)Formulate any scheme of amalgamation with any other borrower/third party or reconstitution any borrower or third party c)Invest by way of share capital in or lend or advance funds to place deposits with any other concerns, except in normal course of business or as advances to employees d)Declare dividends for any year except out of profits relating to that year after making all due and necessary provisions and provided further that no default had occurred in any repayment obligations e)Grant Loans to Promoters/associates and other companies f)Undertake guarantee obligations on behalf of any other borrower or any third party except in normal course of its business g) Withdraw monies brought in by key promoters/depositors h) Make any drastic change in its management set up.` },
      { field1: "7", value1: `The borrower will keep the Namdev Finvest Private Limited informed of the happening of any event, likely to have a substantial effect on their production, sales, profits, etc., such as labour problem, power cut, etc., and the remedial steps proposed to be taken by it.` },
...
//     // ------------------------------------new page 6---------------------------------------
    ...
    const  standardConditionTablee = [
      ...
      { field1: "8", value1: `The borrower will keep the Namdev Finvest Private Limited advised of any circumstances adversely affecting the financial position of its subsidiaries/sister concerns (if any) including any action, taken by any creditor against any of the subsidiaries.` },
      { field1: "9", value1: `The borrower shall furnish to the Namdev Finvest Private Limited, every year, two copies of audited/unaudited financial statements immediately on being published/signed by the auditors/certified by CA.` },
      { field1: "10", value1: `The borrower shall provide ancillary business wherever possible to the Namdev Finvest Private Limited.` },
      { field1: "11", value1: `The interest per annum means interest for 365 days irrespective of leap year` },
      { field1: "12", value1: `The credit facilities shall not be transferred /assigned by the borrower to any other entity without permission of the Namdev Finvest Private Limited. In case there is any transfer/assignment the loan shall be recalled at the sole discretion of the Namdev Finvest Private Limited` },
      { field1: "13", value1: `The Namdev Finvest Private Limited reserves the right to discontinue the facility and to withhold/stop any disbursement without giving any notice in case of non-compliance/breach of any terms and conditions stipulated herein and from time to time as also in the relevant documents or any information/particulars furnished to us is found to be incorrect or in case of any development or situations in the opinion of the Namdev Finvest Private Limited , its interest will be/is likely to be prejudicially affected by such continuation or disbursement.` },
      { field1: "14", value1: `The Namdev Finvest Private Limited reserves the right to revise the spread over Base Rate/G-Sec/LIBOR/MCLR (any other benchmark rate fixed by the Namdev Finvest Private Limited) on the facility Namdev Finvest Private Limited shall have absolute right to decide and apply the spread over the FRR, Spread shall consist of credit risk premium (which is subject to change in case there is substantial change in the Borrowers credit assessment as agreed in this T&C), operating costs and other costs. The same will be reset periodically once in three years from the date of disbursement. The credit risk premium of the borrower shall be reviewed by the Namdev Finvest Private Limited at regular intervals and shall undergo a revision in case of a substantial change in the borrower’s credit assessment.` },
      { field1: "15", value1: `In the event of the borrower committing default in the repayment of term loan instalments or payment of interest on due dates, Namdev Finvest Private Limited shall have an unqualified right to disclose the names of the Borrower and its directors to the Reserve Bank of India (RBI). The borrower shall give its consent to Namdev Finvest Private Limited and / or to RBI to publish its name and the names of its directors as defaulters in such manner and through such medium as Namdev Finvest Private Limited in their absolute discretion may think fit. The aforesaid right shall be available to Namdev Finvest Private Limited in addition to and not in derogation of any other rights available under the Loan Agreement or the General Conditions, as the case may be.` },
      { field1: "16", value1: `The credit facilities granted will be subject to RBI guidelines / Namdev Finvest Private Limited’s policies from time to time.` },
      ...
      { field1: "18", value1: `The borrower shall maintain adequate books and records which should correctly reflect their financial position and operations and it should submit to the Namdev Finvest Private Limited at regular intervals such statements as may be prescribed by the Namdev Finvest Private Limited in terms of the RBI / Namdev Finvest Private Limited's instructions issued from time to time` },
      { field1: "19", value1: `The sanction does not vest with the Borrower any right to claim any damages against the Namdev Finvest Private Limited for any reason whatsoever.` },
      { field1: "20", value1: `The Namdev Finvest Private Limited has a right to cancel / suspend / reduce any of the borrowing / banking facility so granted and to alter / amend / vary the terms of Namdev Finvest Private Limited’s sanction including the rate of interest/margin/repayment period at the Namdev Finvest Private Limited’s sole discretion without having to assign any reason.` },
      { field1: "21", value1: `The borrower shall arrange for inspection of the unit by Namdev Finvest Private Limited’s officials, at its cost, as and when required.` },
...
//     //-------------------------------------new page 7--------------------------------------------------
    ...
    const table = [
      ...
      // { field1: "22", value1: `The company needs to file necessary charges / modification of charges with the Registrar of Companies (as applicable) within 30 days of creation/modification of charges and certificate of Registration/modification of charge shall be submitted for our records` },
      { field1: "23", value1: `The borrower shall adhere to any other covenants stipulated by the Namdev Finvest Private Limited from time to time.` },
      { field1: "24", value1: `Any other terms and conditions, which are not specifically covered herein but stipulated in the sanction, should be strictly complied with.` },
      { field1: "25", value1: `Namdev Finvest Private Limited is entitled to add to, delete or modify all or any of the aforesaid terms and conditions.` },
      { field1: "26", value1: `This sanction letter shall remain in force till the validity period mentioned in this sanction letter from date of sanction. However, the revalidation is subject to and at the sole discretion of the Namdev Finvest Private Limited, on application of the borrower/s.` },
      { field1: "27", value1: `The Loan/facility is at sole discretion of the Namdev Finvest Private Limited.` },
      { field1: "28", value1: `For cases where charge was registered with Registrar of Companies for securities proposed with Namdev Finvest Private Limited, borrower will arrange satisfaction of charge post security creation with Namdev Finvest Private Limited.` },
      { field1: "29", value1: `CERSAI Charges for registration of security interest will be levied as follows. Non-refundable charges levied by Central Registry of Securitization of Asset Reconstruction and Security Interest of India. For Registration of Individual Security Primary and or Collateral created in favour of Namdev Finvest Private Limited i. When facility amount is equal to Rs 5 lacs or lesser, Rs 50 plus GST ii. When facility amount is greater than Rs 5 Lacs, Rs 100 plus GST` },
      { field1: "30", value1: `Insurance renewal condition, Borrower to submit valid copy of Insurance of the property, and other assets duly charged in favour of Namdev Finvest Private Limited. Further borrower to ensure that fresh copy of insurance is provided to the Namdev Finvest Private Limited within 7 days before the expiry of insurance policy. In absence of that, Cash Credit or Overdraft or Current account shall be debited towards the insurance premium amount on the date of expiry of Insurance policy.` },   
  ...
  const kycTable = [
      ...
      { field1: "3", field2: "Disbursal schedule\n (i) Disbursement in stages or 100% upfront.\n(ii) If it is stage wise, mention the clause of loan agreement having relevant details", field3: "" },
...
},
{
    columns: [
        ...
        `1. Namdev Finvest Private Limited
Grievance Officer: 
Designation: 

For any grievances in relation to the loan the customer can call / write to us at 
...
["Fin Coopers Capital Pvt Ltd-0%", "Namdev Finvest Private Limited-100%", `${allPerameters.interestRate}%`],
...
const namdevSectionLatter = async(customerId) =>{
    try {
      ...
      const allPerameters = {
        ...
        sanctionpendencyDate:sanctionPendencyDetails?.sanctionDate || "NA",//page no.1
        ...
        const uploadResponse = await uploadPDFToBucket(pdfPath, `NaamDev_SanctionLatter${Date.now()}.pdf`);
        const Url = uploadResponse.url
        console.log(Url,"url")        
        await finalsanctionModel.findOneAndUpdate(
          { customerId }, // Query to find the specific customer document
          {
            $set: { "naamDevPdflink.naamDevSanctionLetter": Url } // Dot notation for nested update
          },
      ...
      // const updatedDoc = await finalsanctionDetails.findOneAndUpdate(
      //   {
      //     $set : { "naamDevPdfUrls.naamDevSanctionLetterPdf": uploadResponse.url },
      //   }
      // );
      
      // if (!updatedDoc) {
      //   console.log("No document found with the given customerId");
      // }
