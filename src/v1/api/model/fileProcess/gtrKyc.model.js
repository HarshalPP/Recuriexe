...
const gtrKycModel = new Schema({
    ...
    gtrFullNameAsPerVoterId: { type: String , default :"" },
...
const gtrKycDetail = mongoose.model('gtrKyc', gtrKycModel);

module.exports = gtrKycDetail;
