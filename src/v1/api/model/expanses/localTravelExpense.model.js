...
const localTravelModel = new Schema({
    assetId: {
        type: String,
        unique: true,
        required: true,
...
localTravelModel.pre('validate', async function (next) {
    const doc = this;
...
const localTravelDetail = mongoose.model('localTravelExpense', localTravelModel);

module.exports = localTravelDetail;
