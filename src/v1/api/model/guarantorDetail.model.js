...
const guarantorDetailModel = new Schema({
  ...
  formCompleteDate: { type: String , default:""},
    ...
    guarantorPrefix: { type: String, default: "" },
...
const guarantorDetail = mongoose.model("guarantorDetail", guarantorDetailModel);

module.exports = guarantorDetail;
