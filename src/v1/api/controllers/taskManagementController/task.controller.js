import {
  ...
  import groupTaskModel  from "../../models/taskManagement/groupTask.model.js"
  import employeModel  from "../../models/employeemodel/employee.model.js"
//   import attendanceModel  from "../../model/adminMaster/attendance.model.js"
  import moment  from "moment-timezone";
//   import { getFullEmployeeHierarchy }  from "";
...
export const selfTaskDelete = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
...
export const selfTaskUpdate = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
...
export const addGroupTask = async (req, res) => {
  try {
    ...
    const tokenId = new ObjectId(req.employee.id); // ID of the user creating the task
...
export const getAllTask = async (req, res) => {
  try {
    ...
    const employeeId = new ObjectId(req.employee.id); // Extracting employeeId from token
...
export const getTaskByParticularId = async (req, res) => {
  try {
...
export const getTaskEmployeeName = async (req, res) => {
  try {
    const tokenId = new ObjectId(req.employee.id);
...
export const getTaskByManagerId = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
    ...
    const result = await taskModel.aggregate([
      ...
      {
        $project: {
          "employeeDetail.password": 0, "employeeDetail.bankDetails": 0, "employeeDetail.emergencyNumber": 0,
          "employeeDetail.aadhar": 0, "employeeDetail.panCard": 0, "employeeDetail.maritalStatus": 0, "employeeDetail.gender": 0,
          "employeeDetail.bankAccount": 0, "employeeDetail.ifscCode": 0, "employeeDetail.employeePhoto": 0,
          "employeeDetail.currentAddress": 0, "employeeDetail.permanentAddress": 0, "employeeDetail.branchId": 0,
          "employeeDetail.companyId": 0, "employeeDetail.roleId": 0, "employeeDetail.reportingManagerId": 0,
          "employeeDetail.departmentId": 0, "employeeDetail.designationId": 0, "employeeDetail.workLocationId": 0,
          "employeeDetail.constCenterId": 0, "employeeDetail.employementTypeId": 0, "employeeDetail.employeeTypeId": 0,
          "employeeDetail.status": 0, "employeeDetail.description": 0, "employeeDetail.offerLetter": 0,
          "employeeDetail.package": 0, "employeeDetail.resume": 0, "employeeDetail.salutation": 0,
          "employeeDetail.createdAt": 0, "employeeDetail.updatedAt": 0, "employeeDetail.__v": 0,
          "employeeDetail.fatherName": 0, "employeeDetail.employeUniqueId": 0, "employeeDetail.referedById": 0,
          "employeeDetail.bankAccountProof": 0, "employeeDetail.bankName": 0, "employeeDetail.currentAddressCity": 0,
          "employeeDetail.currentAddressPincode": 0, "employeeDetail.currentAddressState": 0, "employeeDetail.currentCTC": 0,
          "employeeDetail.currentDesignation": 0, "employeeDetail.educationCertification": 0,
          "employeeDetail.employmentProof": 0, "employeeDetail.endDate": 0, "employeeDetail.experienceLetter": 0,
          "employeeDetail.familyIncome": 0, "employeeDetail.fathersMobileNo": 0, "employeeDetail.fathersOccupation": 0,
          "employeeDetail.highestQualification": 0, "employeeDetail.lastOrganization": 0, "employeeDetail.motherName": 0,
          "employeeDetail.mothersMobileNo": 0, "employeeDetail.nameAsPerBank": 0, "employeeDetail.permanentAddressCity": 0,
          "employeeDetail.permanentAddressPincode": 0, "employeeDetail.permanentAddressState": 0, "employeeDetail.startDate": 0,
          "employeeDetail.totalExperience": 0, "employeeDetail.university": 0,
          _id: 0,
        },
      },
    ]).sort({ createdAt: -1 });
...
export const replyOnTaskByTaskId = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
  ...
  const currentTime = moment().tz("Asia/Kolkata").format("YYYY-MM-DDTh:mm:ss A")
    ...
    const tokenRemarkId = new ObjectId(req.employee.id)
...
export const getbodEodVerify = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
...
export const taskUpdateByManager = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
...
export const getGroupTaskByToken = async (req, res) => {
  try {
...
export const getGroupTaskByTaskId = async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({
    ...
    const tokenId = new ObjectId(req.employee.id); // Current user's ID
...
export const seenAndUnseenMessageByMessageId = async (req, res) => {
  try {
...
export const getGroupUnseenMessageCount = async (req, res) => {
  try {
    // Check for validation errors
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
...
// ---------GET TASK COUNT API-----------------------------------------------
export const countTaskStatusApi = async (req, res) => {
  try {
      // Validation check
      const errors = validationResult(req);
      if (!errors.isEmpty()) {
...
export const getManagerEmployeeHierarchy = async (req, res) => {
  try {
...
// -----------------** Task Clender APi **---------------------
export const getTaskCalenderApi = async (req, res) => {
  try {
...
//------GET AUTO TASK------
export const getAutoTaskList = async (req, res) => {
  try {
...
export const getAutoTaskListByEmpId = async (req, res) => {
  try {
...
export const autoTaskListApi = async (req, res) => {
  try {
    let matchCondition = {};
